...
#ifndef VIBERSS_TEST_SWIFT_H
#define VIBERSS_TEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VibeRSS_Test",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSXMLParser;
@class NSString;
SWIFT_CLASS("_TtC12VibeRSS_Test10AtomParser")
...
@class NSData;
SWIFT_CLASS("_TtC12VibeRSS_Test9RSSParser")
